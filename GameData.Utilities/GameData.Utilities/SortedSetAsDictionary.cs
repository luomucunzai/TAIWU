...
public class SortedSetAsDictionary<TKey> : IDictionary<TKey, VoidValue>, ICollection<KeyValuePair<TKey, VoidValue>>, IEnumerable<KeyValuePair<TKey, VoidValue>>, IEnumerable where TKey : unmanaged
{
	public struct Enumerator : IEnumerator<KeyValuePair<TKey, VoidValue>>, IEnumerator, IDisposable, IDictionaryEnumerator
	{
		private readonly SortedSet<TKey> _collection;

		private SortedSet<TKey>.Enumerator _enumerator;
		...
		internal Enumerator(SortedSet<TKey> collection)
		{
	...
	public readonly SortedSet<TKey> Collection;
	...
	public SortedSetAsDictionary()
	{
		Collection = new SortedSet<TKey>();
	}
