...
public class AvatarEyeballColorsItem : ConfigItem<AvatarEyeballColorsItem, byte>
{
	...
	public AvatarEyeballColorsItem(byte templateId, string colorHex, byte obbCn, byte obbChn, byte obbJp, byte obbEn, int displayDesc)
	{
		...
		ObbJp = obbJp;
		ObbEn = obbEn;
		DisplayDesc = LocalStringManager.GetConfig("AvatarEyeballColors_language", displayDesc);
	}
