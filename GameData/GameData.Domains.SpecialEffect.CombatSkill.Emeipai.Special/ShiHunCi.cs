...
public class ShiHunCi : CombatSkillEffectBase
{
	...
	public ShiHunCi(CombatSkillKey skillKey)
		: base(skillKey, 2401, -1)
	{
	}
	...
	private void OnCastSkillEnd(DataContext context, int charId, bool isAlly, short skillId, sbyte power, bool interrupted)
	{
		...
		if (!IsSrcSkillPerformed)
		{
			if (PowerMatchAffectRequire(power))
			{
				...
				AppendAffectedData(context, base.CharacterId, (ushort)(base.IsDirect ? 75 : 108), (EDataModifyType)2, -1);
				AddMaxEffectCount();
			}
			else
			{
	...
	{
		if (IsSrcSkillPerformed && isFightBack && (base.IsDirect ? attacker : defender) == base.CombatChar)
		{
	...
	public override int GetModifyValue(AffectedDataKey dataKey, int currModifyValue)
	{
		...
		if (dataKey.FieldId == 75)
		{
			return 50;
		}
		if (dataKey.FieldId == 108)
		{
			return -50;
		}
		return 0;
