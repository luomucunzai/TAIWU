...
public class AddDamageByFiveElementsType : AssistSkillBase
{
	...
	public override int GetModifyValue(AffectedDataKey dataKey, int currModifyValue)
	{
		...
		sbyte b = (sbyte)NeiliType.Instance[base.CurrEnemyChar.GetNeiliType()].FiveElements;
		if ((b == CounteringType && dataKey.FieldId == 69) || (b == CounteredType && dataKey.FieldId == 102))
		{
			_affected = true;
			return 50;
		}
