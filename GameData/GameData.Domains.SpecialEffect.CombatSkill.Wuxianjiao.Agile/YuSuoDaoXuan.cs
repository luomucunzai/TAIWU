...
public class YuSuoDaoXuan : AgileSkillBase
{
	...
	public YuSuoDaoXuan(CombatSkillKey skillKey)
		: base(skillKey, 12604)
	{
	}
	...
	private void OnDistanceChanged(DataContext context, CombatCharacter mover, short distance, bool isMove, bool isForced)
	{
		...
		if (_distanceAccumulator >= 10)
		{
			...
			if (base.CanAffect)
			{
				DomainManager.Combat.AddCombatState(context, base.IsDirect ? base.CombatChar : base.CurrEnemyChar, (sbyte)(base.IsDirect ? 1 : 2), (short)(base.IsDirect ? 61 : 62), 50);
