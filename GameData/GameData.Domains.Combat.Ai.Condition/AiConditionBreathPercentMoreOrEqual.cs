...
{
	public AiConditionBreathPercentMoreOrEqual(IReadOnlyList<string> strings, IReadOnlyList<int> ints)
		: base(strings, ints)
	{
	}
	...
	{
		int num = CValuePercent.ParseInt(checkChar.GetBreathValue(), 30000);
