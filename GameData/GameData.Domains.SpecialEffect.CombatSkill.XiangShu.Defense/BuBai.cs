...
public class BuBai : DefenseSkillBase
{
	...
	public override long GetModifiedValue(AffectedDataKey dataKey, long dataValue)
	{
		...
		(int, int) tuple = CombatDomain.CalcInjuryMarkCount((int)Math.Min(num + dataValue, 2147483647L), injuryStep);
		if (base.CombatChar.GetInjuries().Get(b, flag) + tuple.Item1 >= 6)
		{
